...
/**
 * Context that provides a container element for nested portals (Select, Popover, Combobox)
 * so they render inside the Dialog DOM tree and avoid focus trap issues.
 */
...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      <DialogOverlay />
      {blurBackground && <div className="bg-background/10 backdrop-blur-xs fixed inset-0 z-50" />}
